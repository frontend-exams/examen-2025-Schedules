...
export default function EditScheduleScreen ({ navigation, route }) {
  // En esta pantalla hay que hacer literalmente un formulario
  ...
  const validationSchema = yup.object().shape({
    startTime: yup
      ...
      .matches(
        ...
        'The time must be in HH:mm (e.g. 14:30:00) format'
      ),
    endTime: yup
      .string()
  ...
  // Función update para actualizar el schedule, cuidado con los backendErros que hay que tratarlos
